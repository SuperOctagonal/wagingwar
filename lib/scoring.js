...
export const FACTORS = [
  ...
  // Shipped live 2026-09-18 -- was admin-only preview (2809622) until the
  // edge-finding investigation's out-of-sample-validated gradient using
  // PuntersEdge's own Joc/Trn combo stat (jocTrnWins/jocTrnStarts, captured
  // since the CSV parser's beginning but never scored until now) was
  // confirmed for shipping. Real, but not uniform: the effect is
  // concentrated almost entirely in the top individual-skill tercile
  // (Q4-Q1 gradient ~5.4pp there, OOS-confirmed) and flat-to-nil for
  // below-average jockeys/trainers -- a genuine limitation of applying a
  // flat weight here, accepted as a reasonable first cut rather than
  // building a skill-conditional weight for a first pass.
  { key:'jtrat',     label:'Joc/Trn Combo', grp:'Connections', derived:'jocTrnWin',             metric:'Score_Joc/Trn Win %' },
...
export const FACTOR_GROUPS_DEF = [
  ...
  { key:'conn',  label:'Connections', color:'#7c3aed', factors:[
    {key:'jocrat',label:'Jockey Win%'},{key:'trnrat',label:'Trainer Win%'},{key:'jtrat',label:'Joc/Trn Combo'},
  ]},
];
