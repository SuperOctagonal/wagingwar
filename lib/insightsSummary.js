...
// Temporarily floored at 1 (was 10) rather than removing the gating logic
// entirely -- n=0 groups still show "insufficient data"/get excluded, but
// any real sample (n>=1) now shows its actual percentage. One-line revert
// if this needs to go back.
