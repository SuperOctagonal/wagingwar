// Seeds trivia batch 4 (50 questions) only. Usage: node scripts/seedTriviaBatch4.mjs
import fs from 'fs';
import { TRIVIA_BATCH_4 } from '../lib/gamesTriviaBatch4.js';
...
const res = await fetch(`${SURL}/rest/v1/trivia_questions`, {
  ...
  body: JSON.stringify(TRIVIA_BATCH_4.map(q => ({ ...q, active: true }))),
});
