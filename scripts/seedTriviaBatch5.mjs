// Seeds trivia batch 5 (50 questions) only. Usage: node scripts/seedTriviaBatch5.mjs
import fs from 'fs';
import { TRIVIA_BATCH_5 } from '../lib/gamesTriviaBatch5.js';
...
const res = await fetch(`${SURL}/rest/v1/trivia_questions`, {
  ...
  body: JSON.stringify(TRIVIA_BATCH_5.map(q => ({ ...q, active: true }))),
});
