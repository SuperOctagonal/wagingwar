// Seeds trivia batch 2 (50 questions) only. Usage: node scripts/seedTriviaBatch2.mjs
import fs from 'fs';
import { TRIVIA_BATCH_2 } from '../lib/gamesTriviaBatch2.js';
...
const res = await fetch(`${SURL}/rest/v1/trivia_questions`, {
  ...
  body: JSON.stringify(TRIVIA_BATCH_2.map(q => ({ ...q, active: true }))),
});
