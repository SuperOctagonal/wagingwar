...
export default function InsightsPage() {
  ...
  // ─── filter panel ────────────────────────────────────────────────────────────
  // Server-side filtering, additive to (AND'd with) the existing date-range
  // tabs below — this replaces nothing about how range/customStart/customEnd
  // work. When no filters are active, serverFilteredBets stays null and
  // filteredBets falls back to the original unfiltered `bets`, i.e. zero
